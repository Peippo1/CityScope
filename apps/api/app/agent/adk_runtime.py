...
def build_root_agent() -> Any | None:
    ...
    return LlmAgent(
        ...
        instruction=(
            ...
            "return_to_origin for loops, travel_mode bicycle or walking for running, bounded requested_stops, preferences, and an optional template_id; route planning is supported for every route-enabled city, while historical-demand claims remain limited to historical cities; never emit coordinates or polylines."
        ),
        tools=[
