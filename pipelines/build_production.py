...
def main() -> dict:
    ...
    metadata = {
        ...
        "observation_start": "2026-04-30T23:00:00Z",
        "observation_end_exclusive": "2026-05-31T23:00:00Z",
        "observation_period": "2026-05-01/2026-05-31",
        "observation_timezone": "Europe/London",
        ...
        "exclusions_by_reason": {key: int(value) for key, value in quarantined["exclusion_reason"].value_counts().sort_index().items()},
        "quarantine_file": quarantine_path.name,
        "transformation_version": "cityscope-core-v3-tfl-v2",
        "h3_resolution": 9,
