...
CityScope is a judge-facing bike-share intelligence demo. Historical London, NYC, Chicago, and Washington, DC activity is displayed as a matched May 2026 snapshot and is not live cycling behaviour. Current Citi Bike, Divvy, Capital Bikeshare, and Vélib' station status is operational data and is not used for historical city comparisons.
